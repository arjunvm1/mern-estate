    ...
    const fetchListing = async () => {
      try {
        ...
        if (data.success === false) {
          setError(true)
          setLoading(false)
          return // redirect to home page or show some error message
        }
        setListing(data)
        setLoading(false)
        setError(false)
  ...
  return (
    <>
      <main>
        {listing && (
          <Seo
            title={`${listing.name} | useEstate`}
            description={`${listing.type === "rent" ? "Property for rent" : "Property for sale"} in ${listing.address}. ${listing.description}`}
